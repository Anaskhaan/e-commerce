...
export default function SmartAlertNacklacePage() {
  ...
  const [bigImage, setBigImage] = useState("/necklace.png");
    ...
    <section className='w-full bg-gray-50 py-16 px-6'>
      ...
      <div className='max-w-7xl mx-auto flex flex-col md:flex-row gap-8 items-start'>
        ...
        <div className='relative w-64 md:w-96 h-64 md:h-96 rounded-lg overflow-hidden shadow-lg flex-shrink-0'>
          <Image
            src={bigImage}
            alt='Life Alarm Smart Alert Necklace'
            fill
        ...
        <div className='flex-1 flex flex-col justify-start'>
          <h1 className='text-3xl md:text-4xl font-bold text-gray-800 leading-tight'>
            Life Alert Necklace - Best Medical Alert Pendant for Seniors
          </h1>
          <p className='mt-4 text-gray-600'>
            Stay safe with the Life Alarm Smart Alert Necklace. A trusted
            medical life alert pendant, perfect for seniors with GPS & fall
            detection. Order now!
          </p>
      ...
      <div className='max-w-7xl mx-auto mt-16 grid md:grid-cols-2 gap-8'>
        <div>
          ...
          <p className='mt-4 text-gray-600 leading-relaxed'>
            The Life Alarm Smart Alert Necklace is a trusted medical life alert
            device for seniors in the USA. Lightweight, comfortable, and easy to
            wear, it combines advanced safety features like fall detection, GPS
            tracking, and two-way communication into a sleek pendant design.
          </p>
        </div>
        <div>
