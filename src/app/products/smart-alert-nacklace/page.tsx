...
export default function SmartAlertnacklacePage() {
  const router = useRouter();
  const { addToCart } = useCart();

  const [bigImage, setBigImage] = useState("/nacklace.png");
  const smallImages = [
    "/nacklace.png",
    "/emotions-catching.webp",
    "/nacklace-alt2.png",
    "/nacklace-alt3.png",
  ];
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      id: "smart-alert-nacklace",
      name: "Smart Alert Smart nacklace",
      price: totalPrice,
  ...
  return (
    <main className='w-full bg-gray-50'>
      ...
      <section className='max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10 py-16 px-4'>
        ...
        <div className='flex-1 md:pl-6'>
          <h1 className='text-4xl font-bold text-gray-800'>
            Smart Alert Smart Nacklace
          </h1>
          <p className='text-lg font-medium text-gray-500 mt-2'>
            Best Medical Alert Smartnacklace for Seniors
          </p>
          <p className='mt-4 text-gray-600'>
            Stay safe with the Smart Alert Smart nacklace — GPS, fall detection,
      ...
      <section className='max-w-7xl mx-auto py-16 px-4 space-y-16'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-10'>
          <div className='flex-1 space-y-4'>
            <h2 className='text-2xl md:text-3xl font-semibold text-gray-800'>
              Life Alarm Smart Alert Nacklace: Trusted Life Alert for Seniors
            </h2>
            <p className='text-gray-600 leading-relaxed'>
              ...
              emergencies. The Life Alarm Smart Alert nacklace is a modern,
              reliable, and easy-to-use life alert nacklace designed
              specifically for seniors.
            </p>
            <p className='text-gray-600 leading-relaxed'>
              This medical life alert nacklace isn’t just another gadget — it’s
              a lifeline combining fall detection, GPS tracking, and two-way
          ...
          <div className='flex-1 relative w-full h-80 md:h-96'>
            <Image
              src='/nacklace.png' // replace with actual path
              alt='Life Alarm Smart Alert nacklace'
              fill
              className='object-contain'
            />
          </div>
        ...
        <div className='space-y-6'>
          <h2 className='text-3xl font-bold text-gray-800'>
            Why Choose Life Alarm Over Other Smartnacklacees?
          </h2>
